...
// This header is depreciated.  It exists only for backwards compatibility.
...
LinearOperator CreateMPOperator(Lattice const& L, std::string const& Operator, int Site);
