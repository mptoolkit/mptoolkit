              ...
              WignerEckartBasis<B1T> const& b2)
{
   ...
   typedef typename const_iterator<IrredTensor<T, B1T, B2T, S> >::type iter_type;
   typedef typename const_inner_iterator<IrredTensor<T, B1T, B2T, S> >::type inner_iter_type;
   ...
   IrredTensor<T, B1T, B2T, S> Result(b1.AbelianBasis(), b2.AbelianBasis(), qAbelian);
