           ...
           SumBasis<Basis2T> const& B2)
{
   ...
   static_assert(std::is_same<typename ResultType::Basis1Type, Basis1T>::value, "basis 1 type mismatch");
   static_assert(std::is_same<typename ResultType::Basis2Type, Basis2T>::value, "basis 2 type mismatch");
