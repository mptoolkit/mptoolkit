...
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::int8_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::uint8_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::int16_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::uint16_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::int32_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::uint32_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::int64_t)
DEFINE_ALL_PBINARYBUF_FIXEDSIZE(std::uint64_t)
