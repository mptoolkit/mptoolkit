...
//
// mp-algorithms/itdvp-parallel.h
//
...
#if !defined(MPTOOLKIT_MP_ALGORITHMS_ITDVP_PARALLEL_H)
#define MPTOOLKIT_MP_ALGORITHMS_ITDVP_PARALLEL_H
...
class iTDVP
{
   public:
      ...
      // Find the optimal isometric AL/AR corresponding to the current AC and C.
      void FindAL();
      void FindAR();
