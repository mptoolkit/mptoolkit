...
int main(int argc, char** argv)
{
   if (argc != 5)
   {
      ...
      std::cerr << "usage: kondo-canonical-u1u1 <L> <first-impurity-location>"
   ...
   SiteBlock AuxSite = CreateU1HubbardSite("Naux", "Szaux", "Paux");
   AuxSite["P"] = AuxSite["I"];

   // impurity sites
   SiteBlock RealImpurity = CreateU1SpinSite(0.5);
   SiteBlock AuxImpurity = CreateU1SpinSite(0.5, "Szaux");
   ...
   Lattice SpinUnitCell(SymmetryList("N:U(1),Sz:U(1),Naux:U(1),Szaux:U(1)"), RealImpurity, AuxImpurity);
